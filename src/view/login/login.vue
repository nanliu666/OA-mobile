    ...
    <div class="inputBox">
      ...
      >
        <template #right-icon>
          <i
            class="iconfont"
            :class="passwordType==='password' ? 'icon-basics-eyeopen-outlined' : 'iconfont icon-basics-eyeblind-outlined'"
...
export default {
  ...
  created(){
      ...
      const domain = isProduction ? window.location.protocol + '//' + window.location.host : 'www.bestgrand.com.cn'
